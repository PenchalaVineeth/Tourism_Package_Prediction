...
for col in numeric_cols:
  if data[col].isnull().sum() > 0:
    ...
    print('Missing values for numeric columns were imputed using median strategy')
  else:
    print('There are no Missing values in numerical columns.')
...
for col in categorical_cols:
  if data[col].isnull().sum() > 0:
    ...
    print('Missing values for categorical columns were imputed using mode strategy.')
  else:
    print('There are no Missing values in categorical columns.')
